...
const SideBar: React.FC<{
  ...
  return (
    <div className=" min-h-screen flex justify-center bg-gray-100 dark:bg-black">
      <div className="flex">
        <div
          className={`${mdVisible ? "md:block" : "md:hidden"} ${
            mdVisible ? "hidden" : "block"
          }`}
        >
          <div
            className="flex h-screen flex-col fixed md:sticky top-0 bg-gray-100 overflow-y-auto z-10 dark:bg-black dark:scrollbar-thumb-gray-700 scrollbar-thumb-gray-300 scrollbar-track-gray-200 scrollbar-thin dark:scrollbar-track-gray-500 dark:scrollbar-blue-700"
        ...
        <div className=" max-w-xs h-screen sticky top-0 bg-gray-100 overflow-y-auto dark:bg-black dark:scrollbar-thumb-gray-700 scrollbar-thumb-gray-300 scrollbar-track-gray-200 scrollbar-thin dark:scrollbar-track-gray-500 dark:scrollbar-blue-700">
          <div className=" mx-3 mt-8">
            {headings.map((heading) => (
              <div className={heading.depth == 3 ? "ml-3" : ""}>
                <a
                  href={"#" + heading.slug}
                  className="my-3 block text-xs font-light"
                >
                  {heading.title}
                </a>
              </div>
